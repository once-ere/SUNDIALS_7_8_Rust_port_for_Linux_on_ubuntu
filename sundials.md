...
> **Inherited document.** The public guide to the port: crate map, worked
> example, C-to-Rust API conventions. Its §9 "porting to another platform"
> and every statement that an elementary function resolves to the host libm
> are **superseded** by [`LIBM.md`](LIBM.md): in this repository none of them
> does.
